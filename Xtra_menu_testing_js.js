...
//var filename = "document.getElementById('menu_script')"
...
//{
//if (document.getElementById("menu_script").getAttribute ( "filename" ) == "members")

//	document.write('<li>' + filename + '</li>');
document.write('<li>' + document.getElementById("menu_script").getAttribute ( "filename" ) + '</li>')
//}

document.write('  <li class="menuT"><a href="/aboutus.htm">About Us</a>'); 
...
document.write('      <li><a href="/shintoshi.htm">Karate Shin-Toshi</a></li>');
document.write('    </ul>');
document.write('  </li>');
...
document.write('  <li class="menuT"><a href="/gallery.htm">News</a>'); 
document.write('    <ul id="sub-nav">');
document.write('      <li><a href="/about.htm">Current Events</a></li>');
...
document.write('      <li><a href="/awards_jrstudents.htm">Jr. Dragons<br> Student of the Year</a></li>');
document.write('    </ul>');
document.write('  </li>');



document.write('  <li class="menuT"><a href="/links.htm">Student Resources</a>');
document.write('    <ul id="sub-nav">');
document.write('      <li><a href="/links.htm">School Pledges</a></li>');
document.write('      <li><a href="/links.htm">School Tenets</a></li>');
document.write('      <li><a href="/links.htm">Japanese Numbers</a></li>');
document.write('      <li><a href="/links.htm">Terminology</a></li>');
document.write('      <li><a href="/links.htm">The Uniform</a></li>');
document.write('      <li><a href="/links.htm">Rank Testing</a></li>');
document.write('      <li><a href="/members.htm">Members Only</a>');
document.write('        <ul id="sub-nav">');
document.write('     	   <li><a href="/links.htm">Defenses</a></li>');
document.write('   		   <li><a href="/links.htm">Forms (Quick)</a></li>');
document.write('    	   <li><a href="/PDFgallery.htm" target="_blank">Forms (Detailed)</a></li>');
document.write('        </ul>');
document.write('    </ul>');
document.write('  </li>');
...
document.write('      <li><a href="/careers.htm">Pricing</a></li>');
