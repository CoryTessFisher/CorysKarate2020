...
document.write('    <ul id="sub-nav">');
document.write('      <li><a href="/schedule.htm">Schedule</a></li>');
document.write('      <li><a href="http://www.tanrendokarate.com/cgi-bin/calendar/cal.pl?config=calendar.cfg">Calendar</a></li>');
document.write('    </ul>');
document.write('  </li>');
